...
void Game::processEvents(Player& p1, Player& p2, int players, Map map){
  ...
  if(players == 1){
    ...
    sf::Thread bot (&Player::sickmove, &p2);
    bot.launch();
  ...
  while(clock.getElapsedTime().asMilliseconds() < 150){
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::W)){
      if(pressed || m1[1] == 0) continue;
      m1[0] = -1; m1[1] = 0; pressed = true;
    }
    else if(sf::Keyboard::isKeyPressed(sf::Keyboard::A)){
      if(pressed || m1[0] == 0) continue;
      m1[0] = 0; m1[1] = -1;
      pressed = true; 
    }
      ...
      if(pressed || m1[0] == 0) continue;
      m1[0] = 0; m1[1] = 1;pressed = true; 
    }
    if(players == 2){
      if(sf::Keyboard::isKeyPressed(sf::Keyboard::I)){
	if(p) continue;
	m2[0] = -1; m2[1] = 0;p = true; 
      }
      else if(sf::Keyboard::isKeyPressed(sf::Keyboard::J)){
	if(p) continue;
	m2[0] = 0; m2[1] = -1;p = true; 
      }
